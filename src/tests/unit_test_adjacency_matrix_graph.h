...
bool test_adjacency_matrix_graph_iterator_constructor(){
    Graph *g = new AdjacencyMatrixGraph;
    g->read_file("test.txt");
    g->iterate_neighbors(1);

    cout << "Testing the AdjacencyMatrixGraph iterator's constructor... ";
...
bool test_adjacency_matrix_graph_iterator_next(){
    Graph *g = new AdjacencyMatrixGraph;
    g->read_file("test.txt");
    g->iterate_neighbors(1);
    ...
    cout << "Testing the AdjacencyMatrixGraph iterator's next function... ";
...
bool test_adjacency_matrix_graph_iterator_previous(){
    Graph *g = new AdjacencyMatrixGraph;
    g->read_file("test.txt");
    ...
    cout << "Testing the AdjacencyMatrixGraph iterator's previous function... ";
...
bool test_adjacency_matrix_graph_get_weight_forward(){
    ...
    cout << "Testing the AdjacencyMatrixGraph iterator's get_weight function";
...
bool test_adjacency_matrix_graph_get_weight_backward(){
